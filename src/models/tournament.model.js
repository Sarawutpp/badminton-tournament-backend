...
const tournamentSchema = new Schema(
  {
    ...
    // ✅ [NEW] Field สำหรับกำหนดว่าทัวร์นาเมนต์นี้เป็นสาธารณะหรือไม่
    // true = ทุกคนเห็น, false = เห็นเฉพาะ Admin
    ...
    settings: {
      ...
      matchConfig: {
        ...
        groupStage: {
          ...
          allowDraw: { type: Boolean, default: true }, // เพิ่ม allowDraw ให้ครบตาม frontend
        },
